...
/* Convert a Wiki string into an HTML string.
   ...
   `buri' specifies the base URI.
   `bhl' specifies the base header level.
   `duri' specifies the URI of the data directory.
   `abslen' specifies the maximum length of the abstraction.  If it is negative, no abstraction
   is performed.
   `absobjnum' specifies the maximum number of embedded objects in the abstraction.  If it is
   negative, no limit is set.
   The return value is the total length of the entity texts except tags. */
...
/* Add an inline Wiki string into HTML.
   ...
   `buri' specifies the base URI.
   `duri' specifie the URI of the data directory.
   The return value is the length of the entity text except tags. */
